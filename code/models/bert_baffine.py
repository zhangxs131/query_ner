...
class NezhaBiaffineForNer(AutoModelForPreTraining):
    ...
    def __init__(
        ...
        super(NezhaBiaffineForNer, self).__init__(config)
...
class ErnieBiaffineForNer(ErniePreTrainedModel):
    ...
    def __init__(
        ...
        super(ErnieBiaffineForNer, self).__init__(config)
...
class ElectraBiaffineForNer(ElectraPreTrainedModel):
    ...
    def __init__(
        ...
        super(ElectraBiaffineForNer, self).__init__(config)
